...
function App() {
  return (
    <div className="App">
      ...
      <Text title={"My Hobbies"} body={"While coding is one of my biggest hobbies, I also possess many others. I love music. I played the violin for an extensive amount of time and dabble with the piano on occasion. Many of my hobbies revolve around tech. I'm a custom PC enthusiast. I like to regularly update my PC with the lastest and greatest specs to play the most demanding games. A recent hobby of mine has been playing ping pong. My cohort buddy and I will take advantage of any moment we get to play an intense match of ping pong."}/>
